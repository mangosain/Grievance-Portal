...
const Nav = () => {
  return (
    <nav className="navbar fixed top-0 bg-base-300 bg-opacity-20 backdrop-blur-md z-10 shadow-md md:shadow-none">
      ...
      <div className="navbar-center">
        <Link
          href="/"
          className="btn btn-ghost text-xl text-info hidden md:inline-block"
        >
          Grievance Portal
        </Link>
      </div>
